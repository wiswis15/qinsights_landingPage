...
Use [profile variables and filters](/docs/filters) - demographics, document type, collection date - to build subsets aligned with your research questions, and work dialogically: ask broad questions first to get a sense of the data, then follow up with narrower, targeted ones as your understanding sharpens.
