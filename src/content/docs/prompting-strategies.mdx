...
3. **Identify similarities and differences** across participants, optionally using [profile variables](/docs/data-context) such as gender, age, or education - for Word/PDF data, activate these as filters first; for Excel data, reference them directly in your prompt.
