...
- For each document, review the listed speakers.
- Use the dropdown menu next to each speaker name to assign the correct role.
- Click **Save roles**.

<figure className="docs-article__figure">
  <img className="docs-article__inline-image" src="/docs/38.png" alt="Assign roles" />
  <figcaption className="docs-article__figcaption">Assign roles</figcaption>
</figure>

> **Note:** if speakers are missing or you think they have not been properly identified, you can re-run the process by clicking **Re-detect respondents**.
