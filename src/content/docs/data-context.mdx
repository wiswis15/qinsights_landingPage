...
<Screenshot label="Assign roles" caption="Assigning a role to each detected speaker in Data Context." />
...
<Screenshot label="Create profile" caption="Defining a new characteristic and choosing whether it applies to a speaker or a document." />
...
<Screenshot label="Enter values" caption="Entering the corresponding value for each characteristic, by respondent." />
