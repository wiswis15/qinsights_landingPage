...
<figure className="docs-article__figure">
  <img className="docs-article__inline-image" src="/docs/Opening%20the%20Analysis%20Archive%20from%20the%20project%20menu.png" alt="Opening the Analysis Archive from the project menu." />
  <figcaption className="docs-article__figcaption">Opening the Analysis Archive from the project menu.</figcaption>
</figure>
...
<figure className="docs-article__figure">
  <img className="docs-article__inline-image docs-article__inline-image--compact" src="/docs/50.png" alt="Switching between List View and Folder View." />
  <figcaption className="docs-article__figcaption">Switching between List View and Folder View.</figcaption>
</figure>
...
<figure className="docs-article__figure">
  <img className="docs-article__inline-image" src="/docs/51.png" alt="Analyses organized into folders by research question." />
  <figcaption className="docs-article__figcaption">Analyses organized into folders by research question.</figcaption>
</figure>

## Archive Options

<figure className="docs-article__figure">
  <img className="docs-article__inline-image" src="/docs/52.png" alt="Right-click and action-menu options for a single archived analysis." />
  <figcaption className="docs-article__figcaption">Right-click and action-menu options for a single archived analysis.</figcaption>
</figure>
...
<figure className="docs-article__figure">
  <img className="docs-article__inline-image docs-article__inline-image--compact" src="/docs/53.jpg" alt="Inspecting the documents an analysis is based on." />
  <figcaption className="docs-article__figcaption">Inspecting the documents an analysis is based on.</figcaption>
</figure>
...
<figure className="docs-article__figure">
  <img className="docs-article__inline-image docs-article__inline-image--compact" src="/docs/53(1).png" alt="Right-click and action-menu options for a single archived analysis." />
</figure>
...
<figure className="docs-article__figure">
  <img className="docs-article__inline-image" src="/docs/54.png" alt="Expanding an archived Sentiment Analysis to reopen its linked follow-up chat." />
  <figcaption className="docs-article__figcaption">Expanding an archived Sentiment Analysis to reopen its linked follow-up chat.</figcaption>
</figure>

## Next Steps

See [Prompting Strategies](/docs/prompting-strategies) for how to get the most out of a follow-up chat, or revisit [The Five Analysis Options](/docs/choosing-an-analysis-type) to plan your next run.
