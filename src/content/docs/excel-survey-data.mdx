...
<Screenshot label="Excel input" caption="Required input structure — one sheet, one row per case." />
...
<Screenshot label="Classify columns" caption="Classifying each column as a variable or as text to be analyzed." />
...
<Screenshot label="Respondent values" caption="Example data context imported from an Excel file's variable columns." />
