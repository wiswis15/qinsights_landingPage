...
<Screenshot label="Transcript excerpt" caption="An interview excerpt formatted with clear speaker IDs (INT: / ALEXANDER:)." />
...
<Screenshot label="Detect speakers" caption="Selecting Detect Speakers when uploading a transcript prepared elsewhere." />
...
<Screenshot label="Edit transcript" caption="Reviewing and editing a transcript alongside its audio recording." />
...
<Screenshot label="Speaker names" caption="Renaming detected speakers before assigning roles in Data Context." />
