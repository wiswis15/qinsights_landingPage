...
<figure className="docs-article__figure">
  <img className="docs-article__inline-image docs-article__inline-image--compact" src="/docs/75.png" alt="Choosing which spreadsheet column to run sentiment analysis on." />
...
<figure className="docs-article__figure">
  <img className="docs-article__inline-image docs-article__inline-image--compact" src="/docs/76.png" alt="Defining custom sentiment categories, e.g. emotional vs. rational." />
...
For deeper exploration of specific respondent groups, continue in a follow-up chat, or see [Analysing Data](/docs/analyzing-data) to narrow the dataset before running the analysis.
