...
<Screenshot label="Select column" caption="Choosing which spreadsheet column to run sentiment analysis on." />
...
<Screenshot label="Define categories" caption="Defining custom sentiment categories, e.g. emotional vs. rational." />
...
<Screenshot label="Sentiment results" caption="Pie chart and written summary for a rational vs. emotional sentiment analysis." />
