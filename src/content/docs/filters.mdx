...
<Screenshot label="Set filters" caption="Setting a respondent filter, e.g. all single males." />
...
<Screenshot label="Active filters" caption="Active filter chips displayed above the filtered document list." />
...
<Screenshot label="Select columns" caption="Choosing which spreadsheet columns Q should analyze." />
