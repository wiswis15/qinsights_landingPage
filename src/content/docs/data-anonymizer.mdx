...
<Screenshot label="Anonymizer download" caption="Download the QInsights Anonymizer desktop app from the sidebar." />
...
<Screenshot label="Attach files" caption="QInsights Anonymizer — opening screen for attaching files." />
...
<Screenshot label="Run analysis" caption="Run analysis to identify terms to be anonymized." />
...
<Screenshot label="Entity review" caption="Verifying a detected entity in the context of the document." />
...
<Screenshot label="Save output" caption="Redacted output, with identifiers replaced by consistent placeholders." />
