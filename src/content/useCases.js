...
export const useCases = [
  ...
  },
  {
    ...
    sector: 'Banking',
    headline: 'Thematic Analysis of Permata ME User Reviews',
    summary:
      'Leap Research used QInsights to analyze 1,000 recent Google Play reviews for Permata ME, moving from a poor 2.5-star rating to a clear diagnosis of the reliability issues behind user dissatisfaction.',
    quote:
      'Users are not rejecting Permata ME as a concept. They are rejecting its unreliability.',
    quoteAttribution: 'T.S. Lim, Managing Partner, Leap Research',
    personName: 'T.S. Lim',
    personRole: 'Managing Partner',
    organization: 'Leap Research',
    proofMode: 'named',
    themeAccent: {
      solid: '#1457d9',
      soft: '#eef5ff',
      border: 'rgba(20, 87, 217, 0.18)',
      glow: 'rgba(20, 87, 217, 0.12)',
    },
    intro:
      'QInsights helped Leap Research turn raw app-store frustration into a focused product reliability diagnosis for Permata ME, the Android mobile banking app by Permata Bank.',
    keyOutcomes: [
    ...
    challenge: [
      'On April 13, 2026, T.S. Lim of Leap Research set out to show how QInsights can support thematic analysis of user reviews using Permata ME as a case study.',
      'Permata ME, the Android mobile banking app by Permata Bank, was rated only 2.5 stars out of 5 on the Google Play Store. The rating made the dissatisfaction visible, but it did not explain the specific pain points behind it.',
      'For Permata Bank, the useful question was not simply whether users were unhappy. It was which issues were driving that unhappiness strongly enough to damage trust in the mobile banking experience.',
    ],
    solution: [
      'Leap Research extracted the 1,000 newest Google Play comments, spanning January 17 to April 10, 2026, and reviewed a sample of the raw comments before processing the full dataset.',
      'After uploading the CSV file to QInsights, the team used Guided Conversational Analysis to create positive and negative themes based on the comments only, ignoring the star ratings.',
      'The prompt asked QInsights to output themes in a table with theme name, description, three sample verbatims, actual count, and sentiment, creating a structured bridge between raw user voice and product decision-making.',
    ],
    impact: [
      'QInsights showed that more than 70% of all comments were concentrated in just three themes: app slowness and poor performance, system errors, and login, password, and OTP problems.',
      'Positive feedback existed, but it was fragmented and numerically small. That pattern suggested that user dissatisfaction was being driven by a few structural reliability issues rather than by broad rejection of the app concept or a lack of features.',
    ...
    storyQuotes: [
      {
        text: 'The key analytical insight is that over 70% of all comments are concentrated in just three themes: performance slowness, system errors, and login/authentication failures.',
        attribution: 'T.S. Lim, Leap Research',
      },
      {
        text: 'For this kind of analysis, QInsights functions not just as an analytics tool, but as a qualitative reasoning layer between raw user voice and product decision-making.',
        attribution: 'T.S. Lim, Leap Research',
      },
    ],
    figures: [
